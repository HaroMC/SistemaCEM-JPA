        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    <li>
                        <a href="CEM_perfil.jsp"> Perfil </a>
                    </li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="cem-familias"> Familias </a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="../cem-programas"> Ver listado de programas </a>
                            </li>
                            <li>
                                <a href="CEM_agregarPrograma.jsp"> Agregar programas </a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="CEM_postulasiones_CEL.jsp"> Centros de estudio locales </a>
                            </li>
                            <li>
                                <a href="CEM_postulasiones_alumnos.jsp"> Alumnos </a>
                            </li>
                        </ul>
                    </li>
                </ul>
